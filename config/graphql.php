...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                App\GraphQL\Queries\StatusCategory\StatusCategoriesQuery::class,
                App\GraphQL\Queries\StatusCategory\StatusCategoryTasksQuery::class,
                App\GraphQL\Queries\Task\TaskQuery::class,
                App\GraphQL\Queries\Task\TasksQuery::class,
                App\GraphQL\Queries\User\UserTasksQuery::class
            ],
            'mutation' => [
                ...
                App\GraphQL\Mutations\DeleteAllTaskMutation::class
            ],
            // The types only available in this schema
            'types' => [
                App\GraphQL\Types\StatusCategoryType::class,
